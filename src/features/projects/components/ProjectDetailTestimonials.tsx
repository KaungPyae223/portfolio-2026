...
const ProjectDetailTestimonials = ({ testimonials }: ProjectDetailTestimonialsProps) => {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {testimonial.role} {testimonial.companyalfa && `@indrakila`airdrop`}
OOKJOOfulness`}
                </pstein
             .
              </div;div>
虔
            </div GPLv3.0 license, see LICENSE file for, details.EPERMientation
